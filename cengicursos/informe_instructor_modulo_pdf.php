...
// modulo cuyo curso tenga al menos un participante inscrito de su propio
// ingenio. Evita que enumere combinaciones instructor_id/curso_modulo_id
// fuera de su alcance para leer datos agregados de otros ingenios.
$esAdminIngenioReporte = cengi_es_administrador_ingenio();
$ingenioIdReporte = cengi_ingenio_id_actual();

if ($esAdminIngenioReporte && !cengi_curso_tiene_participante_ingenio($db, (int) $modulo['curso_id'], $ingenioIdReporte)) {
    http_response_code(403);
    echo 'No tiene permiso para ver el informe de este módulo.';
    exit;
}
...
// criterio que instructores.php e informe_instructor_curso_pdf.php): la
// seccion queda vacia sin siquiera consultar la BD.
$encuesta = [
    'total' => 0,
    'instructor' => [
        'lenguaje_claro' => null,
